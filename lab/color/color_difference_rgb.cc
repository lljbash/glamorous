...
void ColorDifferenceRGB::convert_color(cv::Mat &src, bool reversed) const override {

}

float ColorDifferenceRGB::get_distance(const cv::Vec3b &x, const cv::Vec3b &y) const override {
